...
void main() {
  ...
  test('buildCalorieDebugDump prints weekly check-in calculations', () async {
    ...
    expect(result.table, contains('learned_tdee=2000'));
    expect(result.table, contains('new_goal=2000'));
  });
}
