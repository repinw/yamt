...
void main() {
  ...
  test('recalculateTotals keeps bundle totals untouched', () {
    ...
    final recalculated = entry.recalculateTotals(
      updatedAt: DateTime.parse('2026-03-28T08:00:00Z'),
    );

    expect(recalculated.totalKcal, 420);
    expect(recalculated.totalProtein, 28);
    expect(recalculated.totalCarbs, 35);
    expect(recalculated.totalFat, 18);
    expect(recalculated.updatedAt, DateTime.parse('2026-03-28T08:00:00Z'));
  });
}
