...
void main() {
  test('buildCalorieDebugDump prints daily eaten and weight rows', () async {
    ...
    expect(result.table, isNot(contains('activity_day')));
    expect(result.table, isNot(contains('activity_total')));
  ...
  test('buildCalorieDebugDump hides rows before first goal window', () async {
    ...
    expect(result.table, isNot(contains('| 2026-04-08 |  | activity_day |')));
  ...
  test('buildCalorieDebugDump cascades exact weekly check-in goals', () async {
    ...
    expect(result.table, contains('measured_tdee'));
  ...
  test('buildCalorieDebugDump handles non-ready health gracefully', () async {
    ...
    expect(result.table, contains('health_access'));
  });
}
