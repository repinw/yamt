...
void main() {
  group('CalorieProductCacheDocumentCodec', () {
    ...
    test('decodeCalorieProductDocument decodes valid document snapshot',
        () async {
    ...
    test('decodeCalorieProductDocument returns null on malformed document',
        () async {
    ...
    test('decodeOffCacheProductDocument decodes found product snapshot',
        () async {
      final profile = _profile(
        barcode: '4006381333931',
        source: CalorieProductSource.offBarcode,
      );
      final docRef = firestore.collection('off_products').doc('4006381333931');
      await docRef.set({
    ...
    test('decodeOffCacheProductDocument returns null when status is not found',
        () async {
    ...
    test('decodeOffCacheProductDocument returns null on malformed product',
        () async {
    ...
    test('prepareUserOverridePayload sets user_id, reason, and override source',
        () {
      final profile = _profile(
        barcode: '4006381333931',
        source: CalorieProductSource.offBarcode,
