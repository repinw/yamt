...
void main() {
  group('DiaryAccentColors', () {
    ...
    test('lerp returns itself for unrelated extensions', () {
      expect(
        DiaryAccentColors.fallback.lerp(null, 0.5),
        same(DiaryAccentColors.fallback),
      );
    });
  });
}
