...
void _assertAllGettersReturnText(AppLocalizations l10n) {
  final values = <String>[
    ...
    l10n.caloriesEntryGoalShare(34),
    l10n.caloriesEntryPer100Label('g'),
    l10n.caloriesEntryAmountDialogTitle,
    l10n.caloriesEntryAmountLockedMessage,
    l10n.caloriesEditAmountTooltip,
    l10n.caloriesNutritionTableNutrient,
