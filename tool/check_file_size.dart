...
void main(List<String> args) {
  ...
  for (final file in dartFiles) {
    ...
    if (lineCount > maxFileLineLimit &&
      ...
      violations.add('$relativePath: $lineCount lines (max $maxFileLineLimit)');
    }
  }
  ...
  if (violations.isNotEmpty) {
    stderr.writeln(
      '''
❌ Architecture Lint Violation: The following files exceed the $maxFileLineLimit line limit:''',
    );
    ...
    stderr.writeln(
      '''
\nPer architecture.md, split files exceeding 250-300 lines into smaller, focused modules.''',
    );
    exit(1);
  }
  ...
  stdout.writeln(
    '''
✅ Architecture Lint Passed: No unapproved files exceed $maxFileLineLimit lines.''',
  );
}
...
const _legacyLargeFilesAllowlist = <String>{
  ...
  'lib/features/product_search/presentation/controllers/manual_product_search_controller.dart',
  'lib/features/product_search/presentation/controllers/manual_product_search_models.dart',
  'lib/features/product_search/presentation/controllers/manual_product_search_state.dart',
  'lib/features/product_search/presentation/widgets/manual_product_search_form/manual_product_search_form.dart',
  'lib/features/product_search/presentation/widgets/manual_product_search_form/manual_product_search_shell.dart',
  'lib/features/product_search/presentation/widgets/manual_product_search_form_details.dart',
  'lib/features/product_search/presentation/widgets/manual_product_search_launcher_page/manual_product_search_launcher_page.dart',
  'lib/features/product_search/presentation/widgets/manual_product_search_page_route.dart',
  'lib/features/product_search/presentation/widgets/product_ai_search_page/product_ai_search_page.dart',
