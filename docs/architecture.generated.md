...
- Generated at: `2026-04-23T12:11:29.517847Z`
- Features scanned: `15`
- Cross-feature edges: `33`
...
flowchart LR
  ...
  inventory -->|22| calories
  scanner -->|16| inventory
  calories -->|12| health
  product_search -->|12| inventory
  inventory -->|9| auth
  inventory -->|9| household
  calories -->|8| auth
  household -->|7| auth
  scanner -->|7| product_search
  calories -->|6| inventory
...
- `scanner -> inventory` (16 files)
  ...
  - `lib/features/scanner/domain/receipt_item_editor_updater.dart`
...
- `calories -> health` (12 files)
  ...
  - `lib/features/calories/presentation/widgets/calories_activity_card.dart`
  - `... and 7 more`
- `product_search -> inventory` (12 files)
...
- `calories -> auth` (8 files)
  ...
  - `lib/features/calories/data/calorie_barcode_backfill_repository.dart`
...
- `calories -> inventory` (6 files)
  ...
  - `lib/features/calories/presentation/calories_page.dart`
  - `... and 1 more`
...
- `scanner -> calories` (2 files)
  - `lib/features/scanner/application/receipt_review_resolution_service.dart`
  - `lib/features/scanner/provider/receipt_capture_flow_controller.dart`
