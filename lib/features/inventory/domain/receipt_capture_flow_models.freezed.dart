...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( ReceiptInputSource source,  ReceiptAnalysisExtraction extraction)?  completed,TResult Function( ReceiptInputSource source)?  inputCanceled,TResult Function( ReceiptInputSource source,  String errorCode)?  inputUnsupported,TResult Function( ReceiptInputSource source,  String errorCode)?  inputFailed,TResult Function( ReceiptInputSource source,  String errorCode)?  analysisFailed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ReceiptCaptureFlowCompleted() when completed != null:
return completed(_that.source,_that.extraction);case ReceiptCaptureFlowInputCanceled() when inputCanceled != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( ReceiptInputSource source,  ReceiptAnalysisExtraction extraction)  completed,required TResult Function( ReceiptInputSource source)  inputCanceled,required TResult Function( ReceiptInputSource source,  String errorCode)  inputUnsupported,required TResult Function( ReceiptInputSource source,  String errorCode)  inputFailed,required TResult Function( ReceiptInputSource source,  String errorCode)  analysisFailed,}) {final _that = this;
switch (_that) {
case ReceiptCaptureFlowCompleted():
return completed(_that.source,_that.extraction);case ReceiptCaptureFlowInputCanceled():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( ReceiptInputSource source,  ReceiptAnalysisExtraction extraction)?  completed,TResult? Function( ReceiptInputSource source)?  inputCanceled,TResult? Function( ReceiptInputSource source,  String errorCode)?  inputUnsupported,TResult? Function( ReceiptInputSource source,  String errorCode)?  inputFailed,TResult? Function( ReceiptInputSource source,  String errorCode)?  analysisFailed,}) {final _that = this;
switch (_that) {
case ReceiptCaptureFlowCompleted() when completed != null:
return completed(_that.source,_that.extraction);case ReceiptCaptureFlowInputCanceled() when inputCanceled != null:
return inputCanceled(_that.source);case ReceiptCaptureFlowInputUnsupported() when inputUnsupported != null:
...
class ReceiptCaptureFlowCompleted extends ReceiptCaptureFlowResult {
  const ReceiptCaptureFlowCompleted({required this.source, required this.extraction}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReceiptCaptureFlowCompleted&&(identical(other.source, source) || other.source == source)&&(identical(other.extraction, extraction) || other.extraction == extraction));
}


@override
int get hashCode => Object.hash(runtimeType,source,extraction);

@override
String toString() {
  return 'ReceiptCaptureFlowResult.completed(source: $source, extraction: $extraction)';
}
...
@override @useResult
$Res call({
 ReceiptInputSource source, ReceiptAnalysisExtraction extraction
});
...
/// Create a copy of ReceiptCaptureFlowResult
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? source = null,Object? extraction = null,}) {
