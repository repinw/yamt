...
class _FridgeItem extends FridgeItem {
  const _FridgeItem({required this.id, required this.name, required this.entryDate, required this.storeName, required this.quantity, this.initialQuantity = 1, this.unitPrice = 0.0, this.weight, this.initialAmount = 0, this.currentAmount = 0, this.amountUnit, this.barcode, final  List<String> barcodeCandidates = const <String>[], this.foodFingerprint, this.barcodeLookupRequestedAt, this.barcodeResolvedAt, this.brand, this.category, final  Map<String, double> discounts = const <String, double>{}, this.receiptId, this.receiptDate, this.language, this.isDeposit = false, this.isDiscount = false}): _barcodeCandidates = barcodeCandidates,_discounts = discounts,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,entryDate,storeName,quantity,initialQuantity,unitPrice,weight,initialAmount,currentAmount,amountUnit,barcode,const DeepCollectionEquality().hash(_barcodeCandidates),foodFingerprint,barcodeLookupRequestedAt,barcodeResolvedAt,brand,category,const DeepCollectionEquality().hash(_discounts),receiptId,receiptDate,language,isDeposit,isDiscount]);
