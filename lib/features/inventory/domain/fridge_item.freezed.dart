...
mixin _$FridgeItem {
 ...
 String get id; String get name; DateTime get entryDate; String get storeName; int get quantity; int get initialQuantity; double get unitPrice; String? get weight; int get initialAmount; int get currentAmount; FridgeAmountUnit? get amountUnit; String? get barcode; List<String> get barcodeCandidates; String? get foodFingerprint; DateTime? get barcodeLookupRequestedAt; DateTime? get barcodeResolvedAt; bool get barcodeLookupUncertain; String? get brand; String? get category; Map<String, double> get discounts; String? get receiptId; DateTime? get receiptDate; String? get language; bool get isDeposit; bool get isDiscount;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FridgeItem&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.entryDate, entryDate) || other.entryDate == entryDate)&&(identical(other.storeName, storeName) || other.storeName == storeName)&&(identical(other.quantity, quantity) || other.quantity == quantity)&&(identical(other.initialQuantity, initialQuantity) || other.initialQuantity == initialQuantity)&&(identical(other.unitPrice, unitPrice) || other.unitPrice == unitPrice)&&(identical(other.weight, weight) || other.weight == weight)&&(identical(other.initialAmount, initialAmount) || other.initialAmount == initialAmount)&&(identical(other.currentAmount, currentAmount) || other.currentAmount == currentAmount)&&(identical(other.amountUnit, amountUnit) || other.amountUnit == amountUnit)&&(identical(other.barcode, barcode) || other.barcode == barcode)&&const DeepCollectionEquality().equals(other.barcodeCandidates, barcodeCandidates)&&(identical(other.foodFingerprint, foodFingerprint) || other.foodFingerprint == foodFingerprint)&&(identical(other.barcodeLookupRequestedAt, barcodeLookupRequestedAt) || other.barcodeLookupRequestedAt == barcodeLookupRequestedAt)&&(identical(other.barcodeResolvedAt, barcodeResolvedAt) || other.barcodeResolvedAt == barcodeResolvedAt)&&(identical(other.barcodeLookupUncertain, barcodeLookupUncertain) || other.barcodeLookupUncertain == barcodeLookupUncertain)&&(identical(other.brand, brand) || other.brand == brand)&&(identical(other.category, category) || other.category == category)&&const DeepCollectionEquality().equals(other.discounts, discounts)&&(identical(other.receiptId, receiptId) || other.receiptId == receiptId)&&(identical(other.receiptDate, receiptDate) || other.receiptDate == receiptDate)&&(identical(other.language, language) || other.language == language)&&(identical(other.isDeposit, isDeposit) || other.isDeposit == isDeposit)&&(identical(other.isDiscount, isDiscount) || other.isDiscount == isDiscount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,entryDate,storeName,quantity,initialQuantity,unitPrice,weight,initialAmount,currentAmount,amountUnit,barcode,const DeepCollectionEquality().hash(barcodeCandidates),foodFingerprint,barcodeLookupRequestedAt,barcodeResolvedAt,barcodeLookupUncertain,brand,category,const DeepCollectionEquality().hash(discounts),receiptId,receiptDate,language,isDeposit,isDiscount]);

@override
String toString() {
  return 'FridgeItem(id: $id, name: $name, entryDate: $entryDate, storeName: $storeName, quantity: $quantity, initialQuantity: $initialQuantity, unitPrice: $unitPrice, weight: $weight, initialAmount: $initialAmount, currentAmount: $currentAmount, amountUnit: $amountUnit, barcode: $barcode, barcodeCandidates: $barcodeCandidates, foodFingerprint: $foodFingerprint, barcodeLookupRequestedAt: $barcodeLookupRequestedAt, barcodeResolvedAt: $barcodeResolvedAt, barcodeLookupUncertain: $barcodeLookupUncertain, brand: $brand, category: $category, discounts: $discounts, receiptId: $receiptId, receiptDate: $receiptDate, language: $language, isDeposit: $isDeposit, isDiscount: $isDiscount)';
}
...
@useResult
$Res call({
 String id, String name, DateTime entryDate, String storeName, int quantity, int initialQuantity, double unitPrice, String? weight, int initialAmount, int currentAmount, FridgeAmountUnit? amountUnit, String? barcode, List<String> barcodeCandidates, String? foodFingerprint, DateTime? barcodeLookupRequestedAt, DateTime? barcodeResolvedAt, bool barcodeLookupUncertain, String? brand, String? category, Map<String, double> discounts, String? receiptId, DateTime? receiptDate, String? language, bool isDeposit, bool isDiscount
});
...
/// Create a copy of FridgeItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? entryDate = null,Object? storeName = null,Object? quantity = null,Object? initialQuantity = null,Object? unitPrice = null,Object? weight = freezed,Object? initialAmount = null,Object? currentAmount = null,Object? amountUnit = freezed,Object? barcode = freezed,Object? barcodeCandidates = null,Object? foodFingerprint = freezed,Object? barcodeLookupRequestedAt = freezed,Object? barcodeResolvedAt = freezed,Object? barcodeLookupUncertain = null,Object? brand = freezed,Object? category = freezed,Object? discounts = null,Object? receiptId = freezed,Object? receiptDate = freezed,Object? language = freezed,Object? isDeposit = null,Object? isDiscount = null,}) {
...
as String?,initialAmount: null == initialAmount ? _self.initialAmount : initialAmount // ignore: cast_nullable_to_non_nullable
as int,currentAmount: null == currentAmount ? _self.currentAmount : currentAmount // ignore: cast_nullable_to_non_nullable
as int,amountUnit: freezed == amountUnit ? _self.amountUnit : amountUnit // ignore: cast_nullable_to_non_nullable
as FridgeAmountUnit?,barcode: freezed == barcode ? _self.barcode : barcode // ignore: cast_nullable_to_non_nullable
as String?,barcodeCandidates: null == barcodeCandidates ? _self.barcodeCandidates : barcodeCandidates // ignore: cast_nullable_to_non_nullable
as List<String>,foodFingerprint: freezed == foodFingerprint ? _self.foodFingerprint : foodFingerprint // ignore: cast_nullable_to_non_nullable
as String?,barcodeLookupRequestedAt: freezed == barcodeLookupRequestedAt ? _self.barcodeLookupRequestedAt : barcodeLookupRequestedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,barcodeResolvedAt: freezed == barcodeResolvedAt ? _self.barcodeResolvedAt : barcodeResolvedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,barcodeLookupUncertain: null == barcodeLookupUncertain ? _self.barcodeLookupUncertain : barcodeLookupUncertain // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _FridgeItem() when $default != null:
return $default(_that.id,_that.name,_that.entryDate,_that.storeName,_that.quantity,_that.initialQuantity,_that.unitPrice,_that.weight,_that.initialAmount,_that.currentAmount,_that.amountUnit,_that.barcode,_that.barcodeCandidates,_that.foodFingerprint,_that.barcodeLookupRequestedAt,_that.barcodeResolvedAt,_that.barcodeLookupUncertain,_that.brand,_that.category,_that.discounts,_that.receiptId,_that.receiptDate,_that.language,_that.isDeposit,_that.isDiscount);case _:
  return orElse();
...
class _FridgeItem extends FridgeItem {
  const _FridgeItem({required this.id, required this.name, required this.entryDate, required this.storeName, required this.quantity, this.initialQuantity = 1, this.unitPrice = 0.0, this.weight, this.initialAmount = 0, this.currentAmount = 0, this.amountUnit, this.barcode, final  List<String> barcodeCandidates = const <String>[], this.foodFingerprint, this.barcodeLookupRequestedAt, this.barcodeResolvedAt, this.barcodeLookupUncertain = false, this.brand, this.category, final  Map<String, double> discounts = const <String, double>{}, this.receiptId, this.receiptDate, this.language, this.isDeposit = false, this.isDiscount = false}): _barcodeCandidates = barcodeCandidates,_discounts = discounts,super._();
...
@override@JsonKey() final  int initialAmount;
@override@JsonKey() final  int currentAmount;
@override final  FridgeAmountUnit? amountUnit;
@override final  String? barcode;
 final  List<String> _barcodeCandidates;
@override@JsonKey() List<String> get barcodeCandidates {
  if (_barcodeCandidates is EqualUnmodifiableListView) return _barcodeCandidates;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_barcodeCandidates);
}

@override final  String? foodFingerprint;
@override final  DateTime? barcodeLookupRequestedAt;
@override final  DateTime? barcodeResolvedAt;
@override@JsonKey() final  bool barcodeLookupUncertain;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FridgeItem&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.entryDate, entryDate) || other.entryDate == entryDate)&&(identical(other.storeName, storeName) || other.storeName == storeName)&&(identical(other.quantity, quantity) || other.quantity == quantity)&&(identical(other.initialQuantity, initialQuantity) || other.initialQuantity == initialQuantity)&&(identical(other.unitPrice, unitPrice) || other.unitPrice == unitPrice)&&(identical(other.weight, weight) || other.weight == weight)&&(identical(other.initialAmount, initialAmount) || other.initialAmount == initialAmount)&&(identical(other.currentAmount, currentAmount) || other.currentAmount == currentAmount)&&(identical(other.amountUnit, amountUnit) || other.amountUnit == amountUnit)&&(identical(other.barcode, barcode) || other.barcode == barcode)&&const DeepCollectionEquality().equals(other._barcodeCandidates, _barcodeCandidates)&&(identical(other.foodFingerprint, foodFingerprint) || other.foodFingerprint == foodFingerprint)&&(identical(other.barcodeLookupRequestedAt, barcodeLookupRequestedAt) || other.barcodeLookupRequestedAt == barcodeLookupRequestedAt)&&(identical(other.barcodeResolvedAt, barcodeResolvedAt) || other.barcodeResolvedAt == barcodeResolvedAt)&&(identical(other.barcodeLookupUncertain, barcodeLookupUncertain) || other.barcodeLookupUncertain == barcodeLookupUncertain)&&(identical(other.brand, brand) || other.brand == brand)&&(identical(other.category, category) || other.category == category)&&const DeepCollectionEquality().equals(other._discounts, _discounts)&&(identical(other.receiptId, receiptId) || other.receiptId == receiptId)&&(identical(other.receiptDate, receiptDate) || other.receiptDate == receiptDate)&&(identical(other.language, language) || other.language == language)&&(identical(other.isDeposit, isDeposit) || other.isDeposit == isDeposit)&&(identical(other.isDiscount, isDiscount) || other.isDiscount == isDiscount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,entryDate,storeName,quantity,initialQuantity,unitPrice,weight,initialAmount,currentAmount,amountUnit,barcode,const DeepCollectionEquality().hash(_barcodeCandidates),foodFingerprint,barcodeLookupRequestedAt,barcodeResolvedAt,barcodeLookupUncertain,brand,category,const DeepCollectionEquality().hash(_discounts),receiptId,receiptDate,language,isDeposit,isDiscount]);
...
as int,amountUnit: freezed == amountUnit ? _self.amountUnit : amountUnit // ignore: cast_nullable_to_non_nullable
as FridgeAmountUnit?,barcode: freezed == barcode ? _self.barcode : barcode // ignore: cast_nullable_to_non_nullable
as String?,barcodeCandidates: null == barcodeCandidates ? _self._barcodeCandidates : barcodeCandidates // ignore: cast_nullable_to_non_nullable
as List<String>,foodFingerprint: freezed == foodFingerprint ? _self.foodFingerprint : foodFingerprint // ignore: cast_nullable_to_non_nullable
as String?,barcodeLookupRequestedAt: freezed == barcodeLookupRequestedAt ? _self.barcodeLookupRequestedAt : barcodeLookupRequestedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,barcodeResolvedAt: freezed == barcodeResolvedAt ? _self.barcodeResolvedAt : barcodeResolvedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,barcodeLookupUncertain: null == barcodeLookupUncertain ? _self.barcodeLookupUncertain : barcodeLookupUncertain // ignore: cast_nullable_to_non_nullable
