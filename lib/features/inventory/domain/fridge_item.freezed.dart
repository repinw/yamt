...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,entryDate,storeName,quantity,initialQuantity,unitPrice,weight,initialAmount,currentAmount,amountUnit,brand,category,const DeepCollectionEquality().hash(discounts),receiptId,receiptDate,language,isDeposit,isDiscount]);

@override
String toString() {
  return 'FridgeItem(id: $id, name: $name, entryDate: $entryDate, storeName: $storeName, quantity: $quantity, initialQuantity: $initialQuantity, unitPrice: $unitPrice, weight: $weight, initialAmount: $initialAmount, currentAmount: $currentAmount, amountUnit: $amountUnit, brand: $brand, category: $category, discounts: $discounts, receiptId: $receiptId, receiptDate: $receiptDate, language: $language, isDeposit: $isDeposit, isDiscount: $isDiscount)';
}
...
as FridgeAmountUnit?,brand: freezed == brand ? _self.brand : brand // ignore: cast_nullable_to_non_nullable
...
class _FridgeItem extends FridgeItem {
  const _FridgeItem({required this.id, required this.name, required this.entryDate, required this.storeName, required this.quantity, this.initialQuantity = 1, this.unitPrice = 0.0, this.weight, this.initialAmount = 0, this.currentAmount = 0, this.amountUnit, this.brand, this.category, final  Map<String, double> discounts = const <String, double>{}, this.receiptId, this.receiptDate, this.language, this.isDeposit = false, this.isDiscount = false}): _discounts = discounts,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,entryDate,storeName,quantity,initialQuantity,unitPrice,weight,initialAmount,currentAmount,amountUnit,brand,category,const DeepCollectionEquality().hash(_discounts),receiptId,receiptDate,language,isDeposit,isDiscount]);
