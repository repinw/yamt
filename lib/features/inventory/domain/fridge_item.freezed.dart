...
mixin _$FridgeItem {
 ...
 String get id; String get name; DateTime get entryDate; String get storeName; int get quantity; int get initialQuantity; double get unitPrice; String? get weight; int get initialAmount; int get currentAmount; FridgeAmountUnit? get amountUnit; String? get barcode; String? get foodFingerprint; DateTime? get barcodeLookupRequestedAt; DateTime? get barcodeResolvedAt; String? get brand; String? get category; Map<String, double> get discounts; String? get receiptId; DateTime? get receiptDate; String? get language; bool get isDeposit; bool get isDiscount;
...
as String?,foodFingerprint: freezed == foodFingerprint ? _self.foodFingerprint : foodFingerprint // ignore: cast_nullable_to_non_nullable
...
class _FridgeItem extends FridgeItem {
  const _FridgeItem({required this.id, required this.name, required this.entryDate, required this.storeName, required this.quantity, this.initialQuantity = 1, this.unitPrice = 0.0, this.weight, this.initialAmount = 0, this.currentAmount = 0, this.amountUnit, this.barcode, this.foodFingerprint, this.barcodeLookupRequestedAt, this.barcodeResolvedAt, this.brand, this.category, final  Map<String, double> discounts = const <String, double>{}, this.receiptId, this.receiptDate, this.language, this.isDeposit = false, this.isDiscount = false}): _discounts = discounts,super._();
