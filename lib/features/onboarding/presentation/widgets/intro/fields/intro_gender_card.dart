...
class IntroGenderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = isSelected
        ? primary.withValues(alpha: AppIntroLayout.genderSelectedOpacity)
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: borderColor,
                width: isSelected
                    ? AppIntroLayout.choiceBorderWidth
                    : AppIntroLayout.cardBorderWidth,
              ),
            ),
            child: Column(
...
class _GenderIconCircle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final circleColor = isSelected
        ? primary.withValues(alpha: AppIntroLayout.genderIconOpacity)
